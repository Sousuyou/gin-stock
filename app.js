...
(function () {
  ...
  var BOTTLE_PRICE_SEED_URL = "data/bottle_price_estimates_20260625.json?v=20260629-botanical-pc2";
  ...
  var BOT_SYN = {
    ...
    "オリスルート": ["オリス", "オリスルート", "アイリス", "アイリスルート", "イリスルート"],
    "レモンピール": ["レモンピール", "レモン", "レモンの皮", "レモン果皮", "シチリアレモン", "瀬戸内レモン"],
    "オレンジピール": ["オレンジピール", "オレンジ", "オレンジの皮", "ビターオレンジ", "スイートオレンジ", "スウィートオレンジ", "ビターオレンジピール", "スイートオレンジピール", "ビターオレンジの皮", "バレンシアオレンジ", "ネーブルオレンジ", "マンダリン", "マンダリンピール", "タンジェリン", "セビルオレンジ", "シトラスピール", "みかんピール"],
    ...
    "ライム": ["ライム", "ライムピール", "ライムの皮", "ライムゼスト", "フィンガーライム", "シークワーサー"],
    ...
    "グレインズオブパラダイス": ["グレインズオブパラダイス", "グレインオブパラダイス", "ギニアショウガ", "マニゲット"],
    "ビルベリー": ["ビルベリー"],
    "レーズン": ["レーズン"],
    "エルダーベリー": ["エルダーベリー"],
    "チコリルート": ["チコリルート", "チコリ"],
