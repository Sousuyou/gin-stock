...
(function () {
  ...
  var BOTTLE_PRICE_SEED_URL = "data/bottle_price_estimates_20260625.json?v=20260628-botanical-card";
  ...
  var BOT_SYN = {
    ...
    "オレンジピール": ["オレンジピール", "オレンジ", "オレンジの皮", "ビターオレンジ", "スイートオレンジ", "スウィートオレンジ", "ビターオレンジピール", "スイートオレンジピール", "ビターオレンジの皮", "バレンシアオレンジ", "ネーブルオレンジ", "マンダリン", "マンダリンピール", "タンジェリン", "セビルオレンジ", "シトラスピール"],
    ...
    "カモミール": ["カモミール", "カモマイル"],
    "グレープフルーツ": ["グレープフルーツ", "グレープフルーツピール", "グレープフルーツの皮", "ピンクグレープフルーツ", "ポメロ"],
    "ライム": ["ライム", "ライムピール", "ライムの皮", "フィンガーライム", "シークワーサー"],
