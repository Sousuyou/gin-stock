...
(function () {
  ...
  // 情報の確からしさタグ：仮登録＝店員申請の未確認／要確認＝出典あいまいな既存銘柄
  ...
  var BOT_SYN = {
    "ジュニパー": ["ジュニパー", "ジュニパーベリー", "ジェニパーベリー", "ねずの実", "ネズの実", "杜松"],
    "コリアンダー": ["コリアンダー", "コリアンダーシード", "コリアンダーリーフ", "コエンドロ"],
    "アンジェリカ": ["アンジェリカ", "アンジェリカルート", "アンジェリカシード", "アンゼリカ", "アンゼリカルート", "アンジェリカ根", "セイヨウトウキ"],
    "リコリス": ["リコリス", "リコリスルート", "甘草", "カンゾウ"],
    "オリスルート": ["オリス", "オリスルート", "オリス根", "アイリス", "アイリスルート", "イリス", "イリスルート"],
    "レモンピール": ["レモンピール", "レモン", "レモンの皮", "レモン果皮", "シチリアレモン", "瀬戸内レモン"],
    "オレンジピール": ["オレンジピール", "オレンジ", "オレンジの皮", "ビターオレンジ", "スイートオレンジ", "スウィートオレンジ", "ビターオレンジピール", "スイートオレンジピール", "ビターオレンジの皮", "バレンシアオレンジ", "ネーブルオレンジ", "マンダリン", "マンダリンピール", "タンジェリン", "タンジェロ", "セビルオレンジ", "シトラスピール", "みかんピール", "オレンジオイル", "エゾミカン"],
    ...
    "カモミール": ["カモミール", "カモマイル"],
    "グレープフルーツ": ["グレープフルーツ", "グレープフルーツピール", "グレープフルーツの皮", "ピンクグレープフルーツ"],
    "ライム": ["ライム", "ライムピール", "ライムの皮", "ライムゼスト", "フレッシュライム", "フィンガーライム", "シークワーサー", "シークヮーサー", "シークワーサーピール", "シークー", "シークーピール", "カラマンシー", "ブラックレモン"],
    "ローズマリー": ["ローズマリー", "マンネンロウ"],
    "ローレル": ["ローレル", "ローリエ", "ベイリーフ", "月桂樹"],
    "ミント": ["ミント", "イエルバブエナ", "キューバミント", "薄荷", "ハッカ", "赤丸薄荷"],
    "レモングラス": ["レモングラス"],
    "レモンバーベナ": ["レモンバーベナ", "ベルベナ"],
    "ローズヒップ": ["ローズヒップ"],
    "オールスパイス": ["オールスパイス", "ピメント", "ジャマイカペッパー"],
    "紅茶": ["紅茶", "ブラックティー", "アールグレイ"],
    "ブルーベリー": ["ブルーベリー"],
    "ガランガル": ["ガランガル"],
    "キャラウェイシード": ["キャラウェイ", "キャラウェイシード", "キャラエイシード"],
    "クベブペッパー": ["クベブペッパー", "クベブ", "キュベブ", "キュベブペッパー", "クベブベリー", "クベバ", "クベバベリー", "クベバペッパー"],
    "ブラックペッパー": ["ブラックペッパー", "黒胡椒", "胡椒"],
    "グレインズオブパラダイス": ["グレインズオブパラダイス", "グレインオブパラダイス", "ギニアショウガ", "ギニアペッパー", "マニゲット"],
    "ビルベリー": ["ビルベリー"],
    "レーズン": ["レーズン", "ブドウ果皮"],
    "エルダーベリー": ["エルダーベリー"],
    "チコリルート": ["チコリルート", "チコリ"],
    "リンゴンベリー": ["リンゴンベリー"],
    "カフィアライムリーフ": ["カフィアライムリーフ", "こぶみかんの葉", "コブミカンの葉", "コブミカン", "マックルートライムリーフ"],
    "ハマナス": ["ハマナス", "浜茄子"],
    "ヘザー": ["ヘザー"],
    "メドウスイート": ["メドウスイート", "メドウスウィート"],
    "ユーカリ": ["ユーカリ", "レモンセンテッドガム", "ユーカリ・ラディアータ", "ラディアータ", "ペパーミントガムリーフ"],
    "シーバックソーン": ["シーバックソーン", "シーベリー"],
    "ジャスミン": ["ジャスミン"],
    "レモンマートル": ["レモンマートル"],
    "ローワンベリー": ["ローワンベリー", "ナナカマド"],
    "オレンジフラワー": ["オレンジフラワー", "オレンジブロッサム"],
    "パッションフルーツ": ["パッションフルーツ", "パッションフルーツリーフ"],
    "マンゴー": ["マンゴー"],
    "スイートシシリー": ["スイートシシリー"],
    "マックマット": ["マックマット"],
    "エゾノカワラマツバ": ["エゾノカワラマツバ"],
    ...
    "芳樟": ["芳樟", "ホウショウ"],
    "ほうじ茶": ["ほうじ茶", "焙じ茶"],
    "トウヒ": ["トウヒ", "スプルース", "スプルースの新芽", "スプルーストップ", "アカエゾマツ", "ブラックスプルース"],
    "八朔": ["八朔", "はっさく", "ハッサク"],
    "ライチ": ["ライチ"],
    "ビーツ": ["ビーツ", "ビートルート"],
    "ヘーゼルナッツ": ["ヘーゼルナッツ"],
    ...
    "キウイ": ["キウイ"],
    "ハニーサックル": ["ハニーサックル"],
    "ヴァインフラワー": ["ヴァインフラワー", "ブドウ花"],
    "陳皮": ["陳皮"],
    "フランキンセンス": ["フランキンセンス", "乳香"],
    "マカダミアナッツ": ["マカダミアナッツ"],
    "ポメロ": ["ポメロ", "ポメロピール", "文旦"],
    "ホロピト": ["ホロピト"],
    "キタコブシ": ["キタコブシ"],
    "ブラッドオレンジ": ["ブラッドオレンジ"],
    "チェリー": ["チェリー", "さくらんぼ", "サクランボ"],
    "カシス": ["カシス", "ブラックカラント", "黒すぐり"],
    "プラム": ["プラム", "すもも", "スモモ"],
    "桃": ["桃", "もも", "モモ", "ピーチ", "アプリコット"],
    "パイナップル": ["パイナップル"],
    "ハスカップ": ["ハスカップ"],
    "甘夏": ["甘夏", "甘夏ピール", "夏みかん", "青みかん", "日向夏", "橙"],
    "ティムールペッパー": ["ティムールペッパー", "ティムットペッパー", "ティムール", "ティムット"],
    "カカオニブ": ["カカオニブ", "カカオハスク"],
    "梅": ["梅", "うめ", "ウメ"],
    "ココナッツ": ["ココナッツ"],
    "ネトル": ["ネトル", "イラクサ"],
    ...
    "マジョラム": ["マジョラム"],
    "リンデン": ["リンデン", "菩提樹"],
    "ロディオラロゼア": ["ロディオラロゼア", "ロディオラ・ロゼア", "ローズルート"],
    "白樺の葉": ["白樺の葉", "白樺", "シラカバ"],
    "シーソルト": ["シーソルト", "海塩", "塩"],
    "トマト": ["トマト"],
    "バオバブ": ["バオバブ"],
    ...
    "金柑": ["金柑", "キンカン"],
    "唐辛子": ["唐辛子", "とうがらし", "チリ"],
    "仏手柑": ["仏手柑", "ブッシュカン", "ブッダハンド", "シトロン", "セドラ"],
    "蜂蜜": ["蜂蜜", "はちみつ", "ハチミツ", "ハニー"],
    "グラスワート": ["グラスワート", "アッケシソウ"],
    "温州みかん": ["温州みかん", "みかん", "ミカン", "たんかん", "神奈川みかん"],
    "シュガーケルプ": ["シュガーケルプ"],
    "舞茸": ["舞茸", "マイタケ"],
    "落花生": ["落花生", "ピーナッツ"],
    "リンドウ": ["リンドウ", "ゲンチアナ"],
    ...
    "カヤの実": ["カヤの実", "榧の実"],
    "キハダの実": ["キハダの実"],
    "ヴィチペリフェリペッパー": ["ヴィチペリフェリペッパー"],
    "ドーナツ生地": ["ドーナツ生地"],
    "グレーズ": ["グレーズ"],
    "エゾヤマモモ": ["エゾヤマモモ"],
    "マートル": ["マートル", "パナレア島産マートル"],
    "ジンセンベリー": ["ジンセンベリー", "高麗人参", "日本ヤマニンジン葉"],
    "セリ": ["セリ"],
    "ピーマン": ["ピーマン"],
    "ブナの葉": ["ブナの葉"],
    "ベア大麦": ["ベア大麦", "大麦"],
  ...
  var BOT_JUNK = {
    ...
    "ドライフラワー": 1, "枝）": 1, "パラダイス）": 1, "柑橘類": 1,
    "マニゲット（グレインズ": 1,
    "ほかアイラ島産の手摘みボタニカル22種": 1,
  };
  ...
  function roundSalePrice(n) {
    var step = n >= 2000 ? 100 : 50;
    return Math.ceil(n / step) * step;
  }

  function salePriceRange(g) {
    var cost = pourCost(g);
    if (!cost) return null;
    return { low: roundSalePrice(cost / SALE_RATE), high: roundSalePrice(cost / SALE_RATE) };
  }

  function salePriceLabel(g) {
    var range = salePriceRange(g);
    if (!range) return "—";
    return range.low === range.high ? yenLabel(range.low) : yenLabel(range.low) + "〜" + yenLabel(range.high);
  }
  ...
  function cardHTML(g, idx) {
    ...
    var priceBadge = cardBottlePriceBadgeHTML(g);

    var bot = g.botanicals
      ? '<p class="gin-bot">' + esc(g.botanicals) + "</p>"
      : '<p class="gin-bot is-empty">ボタニカル未登録</p>';
    ...
    return (
      '<div class="gin-card-wrap">' +
        ...
        '<button type="button" class="gin-card" data-idx="' + idx + '">' +
          ...
          "</div>" +
          '<div class="gin-badges gin-meta-badges">' + metaBadges + priceBadge + "</div>" +
          warn +
          bot + tags +
        "</button>" +
      "</div>"
  ...
  function updateAromaOutput() {
    var range = document.getElementById("staff-aroma-range");
    var out = document.getElementById("staff-aroma-output");
  ...
  function loadAllAromaStrengths() {
    ...
    fetch(url, { headers: { apikey: SUPABASE_KEY, Authorization: "Bearer " + SUPABASE_KEY } })
      ...
      .then(function (rows) {
        ...
        render();
        if (modalGin && els.modal && !els.modal.hidden) {
          renderAromaSection(modalGin);
          renderStaffEditSection(modalGin);
        }
      })
      .catch(function () {
  ...
  function updateStaffRatingOutput() {
    var range = document.getElementById("staff-rating-range");
    var out = document.getElementById("staff-rating-output");
  ...
  function loadAllStaffRatings() {
    ...
    fetch(url, { headers: { apikey: SUPABASE_KEY, Authorization: "Bearer " + SUPABASE_KEY } })
      ...
      .then(function (rows) {
        ...
        render();
        if (modalGin && els.modal && !els.modal.hidden) {
          renderStaffRatingSection(modalGin);
          renderStaffEditSection(modalGin);
        }
      })
      .catch(function () {
  ...
  function metricEditHTML(g, message) {
    ...
    var rating = g._staffRatingSet ? clampStaffRating(g._staffRating) : 0;
    var priceUnavailable = bottlePriceState === "unavailable";
    ...
    return '<div class="metric-edit-box">' +
      '<div class="staff-price-row">' +
        ...
        '<label class="price-field"><span>容量ml</span><input id="staff-price-ml-input" class="price-input" type="number" inputmode="numeric" min="50" max="3000" step="10" value="' +
          ml + '" placeholder="700" ' + (priceUnavailable ? "disabled" : "") + '/></label>' +
      '</div>' +
      '<div class="staff-metric-control">' +
        '<div class="staff-metric-head"><span>香りの強さ</span><output id="staff-aroma-output" class="aroma-output">' + aroma + '</output></div>' +
        '<div class="metric-scale-row"><span>0</span><input id="staff-aroma-range" class="aroma-range" type="range" min="0" max="10" step="1" value="' + aroma + '"' + (aromaUnavailable ? " disabled" : "") + ' /><span>10</span></div>' +
      '</div>' +
      '<div class="staff-metric-control">' +
  ...
  function postBottlePriceValue(g, price, ml) {
    ...
    return post({ gin_name: g.name, price_yen: price, bottle_ml: ml }).then(function (res) {
      if (res.status === 400) return post({ gin_name: g.name, price_yen: price });
      return res;
    }).then(function (res) {
      if (res.status !== 201) {
        if (res.status === 404) bottlePriceState = "unavailable";
        throw new Error("価格 " + res.status);
      }
      g._bottlePrice = price;
      g._bottlePriceSet = true;
      g._bottleMl = ml;
      g._bottleMlSet = true;
      g._bottlePriceKind = "staff";
      bottlePriceState = "ready";
    });
  }

  function postAromaValue(g, strength) {
    return fetch(SUPABASE_URL + "/rest/v1/" + AROMA_TABLE, {
      method: "POST",
      headers: {
        apikey: SUPABASE_KEY, Authorization: "Bearer " + SUPABASE_KEY,
        "Content-Type": "application/json", Prefer: "return=minimal"
  ...
  function postStaffRatingValue(g, rating) {
    return fetch(SUPABASE_URL + "/rest/v1/" + RATING_TABLE, {
      method: "POST",
      headers: {
        apikey: SUPABASE_KEY, Authorization: "Bearer " + SUPABASE_KEY,
        "Content-Type": "application/json", Prefer: "return=minimal"
  ...
  function submitStaffEdit(g) {
    if (!g) return;
    var msg = document.getElementById("staff-edit-msg");
    var tasks = [];
    var labels = [];
    var priceInput = document.getElementById("staff-price-input");
    var mlInput = document.getElementById("staff-price-ml-input");
    var priceRaw = priceInput && priceInput.value ? priceInput.value.trim() : "";
    if (priceRaw && bottlePriceState !== "unavailable") {
      var price = clampBottlePrice(priceRaw);
      var ml = clampBottleMl(mlInput ? mlInput.value : DEFAULT_BOTTLE_ML);
      if (price <= 0) { if (msg) msg.textContent = "価格は1円以上で入力してください。"; return; }
      if (!g._bottlePriceSet || price !== clampBottlePrice(g._bottlePrice) || ml !== bottleMlValue(g)) {
        tasks.push(function () { return postBottlePriceValue(g, price, ml); });
        labels.push("価格");
      }
    }
    var aromaRange = document.getElementById("staff-aroma-range");
    if (aromaRange && aromaStrengthState !== "unavailable" && aromaRange.getAttribute("data-dirty") === "1") {
      var aroma = Number(aromaRange.value);
      if (!(aroma >= 0 && aroma <= 10)) { if (msg) msg.textContent = "香りの強さは0〜10で選んでください。"; return; }
      tasks.push(function () { return postAromaValue(g, aroma); });
      labels.push("香り");
    }
    var ratingRange = document.getElementById("staff-rating-range");
    if (ratingRange && staffRatingState !== "unavailable" && ratingRange.getAttribute("data-dirty") === "1") {
      var rating = clampStaffRating(ratingRange.value);
      tasks.push(function () { return postStaffRatingValue(g, rating); });
      labels.push("評価");
    }
    ...
    function applyRows(rows, preserveAbsent) {
      ...
      GINS.forEach(function (g) {
        ...
        if (Object.prototype.hasOwnProperty.call(byGin, key) && byGin[key].price > 0) {
          ...
          if (byGin[key].kind) g._bottlePriceKind = byGin[key].kind;
          else if (byGin[key].remote && g._bottlePriceKind === "estimated") g._bottlePriceKind = "staff";
          else if (!g._bottlePriceKind) g._bottlePriceKind = "sourced";
      ...
      render();
      if (modalGin && els.modal && !els.modal.hidden) {
        renderBottlePriceSection(modalGin);
        renderStaffEditSection(modalGin);
      }
    }
  ...
  function init() {
    ...
    fetch("gins.json", { cache: "no-store" })
      ...
      .then(function (data) {
        GINS = (data && data.gins) || [];
        GINS.forEach(function (g) { g._bot = botTokens(g.botanicals); g._tags = g._tags || []; g._aromaStrength = 0; g._aromaStrengthSet = false; g._staffRating = 0; g._staffRatingSet = false; g._bottlePrice = 0; g._bottlePriceSet = false; g._bottleMl = DEFAULT_BOTTLE_ML; g._bottleMlSet = false; g._bottlePriceKind = ""; g._infoSources = []; g._hay = buildHay(g); }); // ボタニカル代表名化＋共有値初期化＋検索用テキスト
        if (els.meta) {
